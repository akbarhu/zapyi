...
//          if(!user){
//             return response.status(400).send("User withd the given email not found.")
//          }
...
// }
  ...
  export const logout = async (request, response, next) => {
    try {
      response.cookie("jwt", "", { maxAge: 1, secure: true, sameSite: "None" }); // Ensure secure is used correctly
