    ...
    <div className='bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10'>
            <div className="flex flex-col gap-10 w-[80vw] md:w-max">
                <div onClick={handleNavigate}>
                 <IoArrowBack className='text-4xl lg:text-4xl text-white text-opacity-90 cursor-pointer'/>   
                ...
                <div className='grid grid-cols-2'>
                  ...
                  <div className='flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center'> 
                    ...
                    <Input placeholder="Name" type="text" onChange={(e) => setFirstName(e.target.value)} value={firstName} className="rounded-lg p-6 bg-[#2c2e3b] border-none"  />
                      {/* <Input  
                      placehoder="Name"
                       type="text" 
