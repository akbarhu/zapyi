...
//     if (selectedChatData._id) {
//         if (selectedChatType === "contact") getMessages();  // Corrected condition check
//     }
// }, [selectedChatData, selectedChatType, setSelectedChatMessages]);
...
//         >
//           {message.content} {/* Display the actual message content here */}
//         </div>
//       )}
...
const MessageContainer = () => {
    ...
    useEffect(() => {
        ...
        if (selectedChatData._id && selectedChatType === "contact") {
            getMessages();  // Corrected condition check
        }
    }, [selectedChatData, selectedChatType, setSelectedChatMessages]);
        ...
        <div className={`${message.sender === selectedChatData._id ? "text-left" : "text-right"}`}>
            ...
            > 
              ...
              {checkIfImage (message.fileUrl)? (<div className="cursor-pointer ">
                <img src={`${HOST}/${message.fileUrl}`} alt=""  height={300} width={300}/> </div> )
    ...
    return (
        <div className="flex-1 overflow-y-auto scrollbar scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full">
        {renderMessages()}
        <div ref={scrollRef} />
    </div>
    );
